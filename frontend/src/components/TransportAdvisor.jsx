    ...
    <div className="space-y-6">
      <div className="card">
        <div className="flex items-center gap-3 mb-5">
          ...
          <h2 className="font-semibold text-gray-900 text-lg">Smart Transport Advisor</h2>
        ...
        {stadium?.transportation && (
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-5">
            {Object.entries(stadium.transportation).map(([mode, info]) => {
              ...
              return (
                <div key={mode} className="bg-gray-50 rounded-xl p-3 border border-gray-200">
                  <div className="text-xs text-gray-600 mb-1">{labels[mode] || mode}</div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
          <div>
            <label className="text-xs text-gray-600 mb-1.5 block">📍 Your Origin</label>
          ...
          <div>
            <label className="text-xs text-gray-600 mb-1.5 block">⏰ Desired Arrival Time</label>
      ...
      {recommendation && (
        <div className="card fade-in-up">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="font-semibold text-gray-900">AI Transport Recommendation</span>
          </div>
